...
const host string = "192.168.2.131:32500"
...
const diskIOQueryL string = "(rate(node_disk_read_bytes_total{device=\"sda\"}[1m]) + rate(node_disk_written_bytes_total{device=\"sda\"}[1m])) /1024 /1024"
